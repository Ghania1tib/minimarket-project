...
<head>
    ...
    <title>Tambah Member - Minimarket</title>
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header bg-primary text-white">
                        <h4 class="mb-0"><i class="fas fa-user-plus me-2"></i>Tambah Member Baru</h4>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('member.store') }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control kode-member @error('kode_member') is-invalid @enderror"
                                       ...
                                       readonly required>
                                <div class="form-text">Kode member digenerate otomatis.</div>
                                @error('kode_member')
