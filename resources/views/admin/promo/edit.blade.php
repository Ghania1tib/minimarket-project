...
<head>
    ...
    <title>Edit Promo - Minimarket</title>
...
<body>
            ...
            <div class="col-lg-10">
                <div class="card">
                    <div class="card-header text-center">
                        <h3 class="mb-2"><i class="fas fa-edit me-2"></i>Edit Promo</h3>
                        <p class="mb-0 opacity-75">Perbarui informasi promo yang sudah ada</p>
                    </div>
                        ...
                        <form action="{{ route('promo.update', $promo->id) }}" method="POST">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-4">
                                    ...
                                    <input type="text" class="form-control @error('nama_promo') is-invalid @enderror"
                                           id="nama_promo" name="nama_promo" value="{{ old('nama_promo', $promo->nama_promo) }}"
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <input type="text" class="form-control @error('kode_promo') is-invalid @enderror"
                                           id="kode_promo" name="kode_promo" value="{{ old('kode_promo', $promo->kode_promo) }}"
                                ...
                                <div class="col-md-4 mb-4">
                                    ...
                                    <div class="input-group">
                                        <input type="number" step="0.01" class="form-control @error('diskon') is-invalid @enderror"
                                               id="diskon" name="diskon" value="{{ old('diskon', $promo->diskon) }}"
                                ...
                                <div class="col-md-4 mb-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" class="form-control @error('minimal_pembelian') is-invalid @enderror"
                                               ...
                                               value="{{ old('minimal_pembelian', $promo->minimal_pembelian) }}" min="0" required>
                                ...
                                <div class="col-md-4 mb-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" class="form-control @error('maksimal_diskon') is-invalid @enderror"
                                               ...
                                               value="{{ old('maksimal_diskon', $promo->maksimal_diskon) }}" min="0">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-4">
                                    ...
                                    <input type="datetime-local" class="form-control @error('tanggal_mulai') is-invalid @enderror"
                                           ...
                                           value="{{ old('tanggal_mulai', $promo->tanggal_mulai->format('Y-m-d\TH:i')) }}" required>
                                    @error('tanggal_mulai')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <input type="datetime-local" class="form-control @error('tanggal_berakhir') is-invalid @enderror"
                                           ...
                                           value="{{ old('tanggal_berakhir', $promo->tanggal_berakhir->format('Y-m-d\TH:i')) }}" required>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-4">
                                    ...
                                    <input type="number" class="form-control @error('kuota') is-invalid @enderror"
                                           id="kuota" name="kuota" value="{{ old('kuota', $promo->kuota) }}"
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <select class="form-select @error('status') is-invalid @enderror" id="status" name="status" required>
                                        ...
                                        <option value="inactive" {{ old('status', $promo->status) == 'inactive' ? 'selected' : '' }}>⏸️ Nonaktif</option>
                                    </select>
                                    @error('status')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="mb-4">
                                ...
                                <textarea class="form-control @error('deskripsi') is-invalid @enderror"
                                          ...
                                          placeholder="Jelaskan detail promo kepada pelanggan...">{{ old('deskripsi', $promo->deskripsi) }}</textarea>
                                @error('deskripsi')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="d-flex justify-content-between align-items-center pt-3">
                                ...
                                <div>
                                    <a href="{{ route('promo.show', $promo->id) }}" class="btn btn-info me-2" style="background: var(--lilac); border: none;">
    ...
    <script>
        // Set minimal datetime untuk tanggal berakhir berdasarkan tanggal mulai
