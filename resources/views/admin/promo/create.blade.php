...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Tambah Promo Baru</h1>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('kode_promo') is-invalid @enderror"
                                   id="kode_promo" name="kode_promo" value="{{ old('kode_promo') }}" required>
                            @error('kode_promo')
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select class="form-control @error('jenis_promo') is-invalid @enderror"
                                ...
                                <option value="diskon_persentase" {{ old('jenis_promo') == 'diskon_persentase' ? 'selected' : '' }}>
                                    Diskon Persentase
                                </option>
                                <option value="diskon_nominal" {{ old('jenis_promo') == 'diskon_nominal' ? 'selected' : '' }}>
                                    Diskon Nominal
                                </option>
                            </select>
                            @error('jenis_promo')
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" step="0.01" class="form-control @error('nilai_promo') is-invalid @enderror"
                                   id="nilai_promo" name="nilai_promo" value="{{ old('nilai_promo') }}" required>
                            @error('nilai_promo')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control @error('kuota') is-invalid @enderror"
                                   id="kuota" name="kuota" value="{{ old('kuota') }}" placeholder="Kosongkan untuk unlimited">
                            @error('kuota')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control @error('minimal_pembelian') is-invalid @enderror"
                                   id="minimal_pembelian" name="minimal_pembelian" value="{{ old('minimal_pembelian', 0) }}">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control @error('maksimal_diskon') is-invalid @enderror"
                                   id="maksimal_diskon" name="maksimal_diskon" value="{{ old('maksimal_diskon') }}">
